...
<body>
<header><div class="nav"><div><h1>Jarvis Models Center</h1><p>Controlled local generation · Explicit use · Metadata-only history</p></div><div class="actions"><a class="button-link" href="/dashboard">Dashboard</a><a class="button-link" href="/knowledge">Knowledge Library</a><a class="button-link" href="/memory">Memory Center</a></div></div></header>
<main>
